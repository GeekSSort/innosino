...
/**
 * Detail routes are dynamic and every one of them composes the pill itself, so
 * they are matched by prefix rather than listed.
 */
const PREFIXES_WITH_INLINE_NAV = ["/blogs/", "/career/", "/projects/", "/services/"];
          ...
          {openPanel === "more" &&
            panelShell(
              ...
              <div className="nav-panel__cloud">
                ...
                <span className="nav-panel__follow">

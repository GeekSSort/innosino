  ...
  return (
    <section
      style={{
        ...
        height: "810px",
        overflow: "hidden",
        backgroundColor: "rgba(255, 112, 24, 1)", // rgb(1, 0.439, 0.094) -> #FF7018
        margin: "0 auto",
      }}
    >
      {/* Frame 8 (I1498:14095;811:2743): Top-left rounded card outline
      ...
      {/* Frame 7 (I1498:14095;811:2746): Top angled white line
      ...
      {/* Core Services Text (I1498:14095;811:2747):
          x: 335, y: 372, w: 436, h: 83, font: Cal Sans 64px, uppercase, fill: #FFFFFF */}
      <div
        style={{
          position: "absolute",
          left: "335px",
      ...
      {/* Frame 9 (I1498:14095;811:2742): Bottom-left pill/circle outline
      ...
      {/* Frame 4 (I1498:14095;811:2745): Bottom angled white line
      ...
      {/* Frame 2 (I1498:14095;811:2744): Bottom circle outline

...
import { formatPostDate, readTime } from "@/lib/post-format";
import type { Post, SiteSettings } from "@/sanity/queries";

export interface BlogsIndexProps {
  posts: Post[];
  /** Filter pills, in the order the Studio lists them. "All" is added here. */
  categories: string[];
  hero: { breadcrumb: string; title: string; sub: string };
...
export default function BlogsIndex({
  ...
  const filteredBlogs = posts.slice(1).filter((post) => {
            ...
            <div className="pj-featured__body">
              ...
              >
                ...
                <div className="blog-byline" style={{ marginBlockStart: "4px" }}>
                  <span className="blog-byline__avatar">{featured.authorInitials}</span>
                  <span>
                    <span className="blog-byline__name">{featured.author}</span>
            ...
            {pageBlogs.map((post) => (
              ...
              >
                ...
                <div className="blog-byline">
                  ...
                  <span>
                    <span className="blog-byline__name">{post.author}</span>
